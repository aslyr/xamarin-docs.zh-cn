...
|类型|说明|扩展点|主机应用|
|--- |--- |--- |--- |
|操作|特定媒体类型的专用编辑器或查看器|`com.apple.ui-services`|Any|
...
|键盘|备用键盘|`com.apple.keyboard-service`|Any|
|照片编辑|照片操作和编辑|`com.apple.photo-editing`|照片应用编辑器|
|共享|与社交网络、消息服务等共享数据。|`com.apple.share-services`|Any|

...
![已选择 iOS 项目作为启动项目](ipa-support-images/setasstartup.png)
...
1. 在 Visual Studio for Mac 中选择“发布 | 设备”配置： !
    ...
    ![选择“发布 | 设备”配置](ipa-support-images/buildxs01new.png)

1. 在“生成”菜单中，选择“存档以供发布”：

    ![选择“存档以供发布”](ipa-support-images/buildxs02new.png)

1. 存档创建完成后，将显示“存档”视图：

    ![将显示“存档”视图](ipa-support-images/buildxs03new.png)
...
1. 选择“签名并分发...”按钮，如下所示：
    ...
    ![选择“签名和分发...”](ipa-support-images/buildxs04new.png)

1. 这将打开发布向导。 选择 **Ad-Hoc** 或“企业”(In-House) 分发渠道来创建包：

    ![选择“临时”或“企业内部”分发](ipa-support-images/distribute01.png)

1. 在“配置文件”屏幕上，选择签名标识和对应的配置文件，或使用其他标识重新签名：

    ![选择签名标识和相应的预配配置文件](ipa-support-images/distribute02.png)

1. 验证包的详细信息，然后单击“发布”：

    ![验证包的详细信息](ipa-support-images/distribute03.png)

1. 最后，将 IPA 保存到计算机：

    ![将 IPA 保存到计算机](ipa-support-images/distribute04.png)
...
1. 确保已选中“项目选项”>“iOS IPA 选项”>“包含 iTunes 图稿图像”，并且已选中“生成 Ad-Hoc/企业包 (IPA)”：
    ...
    ![添加 iTunesArtwork 图像并选中“生成临时/企业包 IPA”](ipa-support-images/imagexs04.png)
...
1. 如果要包含可选的 **iTunesMetadata.plist** 文件，请单击“...”选项，从列表选择它，然后单击“确定”按钮：
     ...
     ![从列表中选择 iTunesMetadata.plist](ipa-support-images/imagexs03.png)
...
1. 在“解决方案资源管理器”中，右键单击 Xamarin.iOS 项目名称，选择“属性”将其打开进行编辑：
    ...
    ![选择“属性”](ipa-support-images/imagevs01.png)

2. 选择“iOS IPA 选项”，然后从“配置”下拉列表选择“Ad-Hoc”：

    ![从“配置”下拉列表选择“临时”](ipa-support-images/imagevs02.png)
...
3. 如果要包含可选 **iTunesMetadata.plist** 文件，请单击“...”选项，从列表中选择它，然后单击“打开”按钮：
    ...
    ![从列表中选择 iTunesMetadata.plist](ipa-support-images/imagevs03.png)

4. 可选择指定 IPA 的**包名称**，若未指定，则将使用与 Xamarin.iOS 项目相同的名称。
5. 保存对“项目属性”所做的更改。
6. 如果可用，从“生成配置”下拉列表选择“Ad Hoc”。 否则，选择“发布”：

    ![从“生成配置”下拉列表选择“临时”](ipa-support-images/imagevs05.png)

7. 生成项目以创建 IPA 包。
8. IPA 将在“Bin”>“iOS 设备”>“Ad Hoc”（或 Release）文件夹中生成：

    ![文件资源管理器中的 IPA](ipa-support-images/imagevs06.png)
...
# <a name="visual-studio-for-mac"></a>[Visual Studio for Mac](#tab/macos)
 ...
 ![“我的应用”部分中的新 iOS 应用程序](ipa-support-images/installxs01.png)

# <a name="visual-studio"></a>[Visual Studio](#tab/windows)

 ![“我的应用”部分中的新 iOS 应用程序](ipa-support-images/installvs01.png)

---
title: title:“从右到左本地化”说明：“从右到左本地化为 Xamarin.Forms 应用程序添加了对从右到左流方向的支持。”
description: 'ms.prod: xamarin ms.assetid:90E0CB16-C42A-4CC8-A70E-0C2CFB64A429 ms.technology: xamarin-forms ms.custom: xamu-video author: davidbritch ms.author: dabritch ms.date:2018/05/07 no-loc: [Xamarin.Forms, Xamarin.Essentials]'
ms.prod: xamarin

...
ms.locfileid: "82516764"
---
# <a name="xaml-controls"></a>XAML 控件

[![下载示例](~/media/shared/download.png)下载示例](https://docs.microsoft.com/samples/xamarin/xamarin-forms-samples/formsgallery)

视图是用户界面对象（如标签、按钮和滑块），这些对象通常称为*控件*或其他图形编程环境中的*小组件*。 Xamarin 支持的视图均派生自[`View`](xref:Xamarin.Forms.View)类。
...
| <h3>Slider</h3>允许从连续范围中`double`选择值。<p align="center">![滚动条的屏幕截图](xaml-controls-images/Slider.png "Slider")</p>[API](xref:Xamarin.Forms.Slider) / [指南](~/xamarin-forms/user-interface/slider.md) | <p valign="center"><pre>&lt;Slider Minimum="0"<br />        Maximum="100"<br />        VerticalOptions="CenterAndExpand" /&gt;</pre></p> |
| <h3>步进器</h3>允许从增量范围中`double`选择值。<p align="center">![分档器的屏幕截图](xaml-controls-images/Stepper.png "步进器")</p>[API](xref:Xamarin.Forms.Stepper) / [指南](~/xamarin-forms/user-interface/stepper.md) | <p valign="center"><pre>&lt;Stepper Minimum="0"<br />         Maximum="10"<br />         Increment="0.1"<br />         HorizontalOptions="Center"<br />         VerticalOptions="CenterAndExpand" /&gt;</pre></p> |
